...
public class Main {
	...
	public static char intToChar(int j) {
		switch (j) {
		case 0:
			return 'U';
		case 1:
	...
	public static void bfs() {
		...
		while (!q.isEmpty()) {
			...
			for (int j = 0; j < 4; j++) {
				...
				goalR = false;
				goalB = false;
				if (move(j, i.count, i.route + intToChar(j))) {
					q.add(new Info(i.count + 1, B.x, B.y, R.x, R.y, i.route + intToChar(j)));
				}
			}			
		}
	...
	public static boolean move(int direction, int count, String route) {
